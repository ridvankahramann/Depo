          ...
          <?php $this->load->view("back/include/header_desktop"); ?>
            ...
            <div class="main-content">
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-12">
                    <h3 class="title-5 m-b-35">Birim</h3>
                        ...
                        <thead>
                          <tr>
                            ...
                            <th style="float:right;">
                              <a href="<?= base_url('index.php/unit/index'); ?>" class="au-btn au-btn-icon au-btn--green au-btn--small"><i class="zmdi zmdi-plus"></i>Kayıt</a>
                        ...
                        <tbody>
                          ...
                          foreach ($search as $key => $value) {
                              echo '<tr class="tr-shadow">
                                <td>
                                  <span class="status--process">'.$value['id'].'</span>
                                </td>
                                <td>
                                  <span class="block-email">'.$value['unit'].'</span>
                                </td>
                                <td></td>
                                <td>
                                ...
                                <td>
                                  <div class="table-data-feature">
                                    <a href="'.base_url('index.php/unit/index/'.$value['id']).'" class="item" data-toggle="tooltip" data-placement="top" title="Değiştir">
                                      <i class="zmdi zmdi-edit"></i>
                                    </a>
                                    <button id="godelete" href="javascript:;" baseurl="'.base_url("index.php/unit_list/delete/").'"  onclick="Delete('.$value['id'].');" class="item" data-toggle="tooltip" data-placement="top" title="Sil">
                ...
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form class="form-header" action="<?= base_url("index.php/unit_list/search") ?>" method="POST">
